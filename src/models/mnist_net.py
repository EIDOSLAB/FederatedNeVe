...
class EmnistBasicBlock(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None):
        super(EmnistBasicBlock, self).__init__()
...
def emnist_resnet18(num_classes):
    """Constructs a ResNet-18 model."""
    model = EmnistResNet(block=EmnistBasicBlock, layers=[2, 2, 2, 2], num_classes=num_classes)
    return model
